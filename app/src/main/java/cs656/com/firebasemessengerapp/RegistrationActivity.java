...
import cs656.com.firebasemessengerapp.model.UserProfile;
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void setupUIViews(){
        ...
        userAge = (EditText)findViewById(R.id.etMobile);
    ...
    private void sendUserData(){
        ...
        DatabaseReference myRef = firebaseDatabase.getReference(Constants.USERS_LOCATION).child(EmailEncoding.commaEncodePeriod(currentEmail)).child("userinfo");
